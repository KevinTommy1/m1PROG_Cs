    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            weapons = new Weapon[4] {
                new Weapon( "red bolt",weaponSprites[0],new StraightBulletMover(), 10),
                new Weapon( "lazer",weaponSprites[1],new StraightBulletMover(), 20),
                new Weapon( "piercing rect",weaponSprites[2],new DownwardBulletMover(), 20),
                new Weapon( "green bolt",weaponSprites[3],new DiagonalBulletMover(), 30)
            };
