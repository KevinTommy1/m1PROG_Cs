    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            weapons = new Weapon[5] {
                new Weapon( "red bolt",weaponSprites[0], 100),
                new Weapon( "lazer",weaponSprites[1], 200),
                new Weapon( "piercing rect",weaponSprites[2], 300),
                new Weapon( "green bolt",weaponSprites[3], 20),
                new Weapon("drone",weaponSprites[4], 2)
            };
        ...
        {
           float speed = weapons[currentWeapon].speed;
